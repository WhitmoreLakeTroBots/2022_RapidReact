...
public class CmdGrabClimb extends CommandBase {

    private boolean bdone = false;
    private double ClimbSpeed = 0;

    public CmdGrabClimb(double climbSpeed) {
    ...
    //extend climb 
        RobotContainer.getInstance().subClimber.SetClimbPos(RobotContainer.getInstance().subClimber.getClimbGrabPos());
