...
public class AutoDriveProfileGyro extends CommandBase{
	...
	public AutoDriveProfileGyro(SubDriveTrain newDriveTrain, SubGyro newGyro) {
	...
	public void SetParameters (double requestedHeading, double cruiseSpeed, double distance) {
	...
	public void SetParameters (double cruiseSpeed, double distance) {
	...
	public void execute() {
		...
		double currentHeading = subGyro.getNormaliziedNavxAngle();
