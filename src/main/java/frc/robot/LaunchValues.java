...
public class LaunchValues {
    ...
    public static final double[][] LaunchCodes = {
            ...
            { 29.00, 2321.0 },  // 6 Target aquired about 6 feet from hub
            { 27.12, 2467.0 },  // 7
            { 21.00, 2612.0 },  // 8
            { 15.00, 2758.0 },  // 9
            { 6.75, 2903.0 },  // 10
            { 3.4, 3049.0 },   // 11 //sweet spot shooting here
            { 5.00, 3194.0 },   // 12
            { 4.00, 3340.0 },   // 13
            { 3.00, 3485.0 },   // 14
            { 0.00, 3631.0 },   // 15
            { -3.00, 3776.0 },  // 16
            { -4.00, 3922.0 },  // 17 // near safe zone (203 inches)
            { -5.00, 4067.0 },  // 18
            { -6.54, 4213.0 },  // 19
            { -10.00, 4358.0 }, // 20 // far safe zone (245 inches)
            { -15.00, 4504.0 }, // 21
