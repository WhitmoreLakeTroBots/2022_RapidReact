...
public class BobController extends Joystick {
	...
	//public Button leftTriggerButton = new Axis.XboxLeftTrigger();
	...
	public double getLeftTriggerValue() {return this.getRawAxis(2);}

	public double getRightTriggerValue() {return this.getRawAxis(3);}
